...
import org.rsmod.plugins.cache.Js5Archives.ANIMS
import org.rsmod.plugins.cache.Js5Archives.BASES
import org.rsmod.plugins.cache.Js5Archives.BINARY
import org.rsmod.plugins.cache.Js5Archives.CLIENT_SCRIPTS
import org.rsmod.plugins.cache.Js5Archives.CONFIG
import org.rsmod.plugins.cache.Js5Archives.DEFAULTS
import org.rsmod.plugins.cache.Js5Archives.FONT_METRICS
import org.rsmod.plugins.cache.Js5Archives.INSTRUMENTS
import org.rsmod.plugins.cache.Js5Archives.INTERFACES
import org.rsmod.plugins.cache.Js5Archives.JINGLES
import org.rsmod.plugins.cache.Js5Archives.MAPS
import org.rsmod.plugins.cache.Js5Archives.MODELS
import org.rsmod.plugins.cache.Js5Archives.MUSIC
import org.rsmod.plugins.cache.Js5Archives.SPRITES
import org.rsmod.plugins.cache.Js5Archives.SYNTHS
import org.rsmod.plugins.cache.Js5Archives.TEXTURES
import org.rsmod.plugins.cache.Js5Archives.TOTAL_ARCHIVES
import org.rsmod.plugins.cache.Js5Archives.VORBIS
import org.rsmod.plugins.cache.Js5Archives.WORLD_MAP_DATA
import org.rsmod.plugins.cache.Js5Archives.WORLD_MAP_GEO
import org.rsmod.plugins.cache.Js5Archives.WORLD_MAP_GEO_LEGACY
import org.rsmod.plugins.cache.Js5Archives.WORLD_MAP_GROUND
import com.google.inject.Injector
import org.rsmod.game.scripts.plugin.KotlinScriptPlugin

class LoginPlugin(injector: Injector) : KotlinScriptPlugin(injector) {
